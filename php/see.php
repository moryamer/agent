...
require_once __DIR__ . '_safe_wrappers.php';// If _safe_wrappers.php is in the parent directory (htdocs/), you'd use:
...
require_once __DIR__ . 'db.php';// If db.php is in the main htdocs/ folder, you'd use:
